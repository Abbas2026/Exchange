...
static constexpr auto qt_meta_stringdata_ZN10SmtpClientE = QtMocHelpers::stringData(
    "SmtpClient",
    "onConnected",
    "",
    "onReadyRead",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10SmtpClientE[] = {
...
Q_CONSTINIT const QMetaObject SmtpClient::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10SmtpClientE.offsetsAndSizes,
    qt_meta_data_ZN10SmtpClientE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10SmtpClientE_t,
        // Q_OBJECT / Q_GADGET
...
void *SmtpClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10SmtpClientE.stringdata0))
