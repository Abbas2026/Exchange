...
static constexpr auto qt_meta_stringdata_ZN6signinE = QtMocHelpers::stringData(
    "signin",
    "sendservertologin",
    "",
    "email",
    ...
    "on_forgotbtnsend_clicked"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
#endif // !QT_MOC_HAS_STRINGDATA

Q_CONSTINIT static const uint qt_meta_data_ZN6signinE[] = {
...
Q_CONSTINIT const QMetaObject signin::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6signinE.offsetsAndSizes,
    qt_meta_data_ZN6signinE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6signinE_t,
        // Q_OBJECT / Q_GADGET
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_forgot_password_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_forgotbtnsend_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void signin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (signin::*)(const QString & , const QString & );
            if (_q_method_type _q_method = &signin::sendservertologin; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (signin::*)();
            if (_q_method_type _q_method = &signin::backToFormRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *signin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6signinE.stringdata0))
...
// SIGNAL 0
void signin::sendservertologin(const QString & _t1, const QString & _t2)
{
...
// SIGNAL 1
void signin::backToFormRequested()
{
